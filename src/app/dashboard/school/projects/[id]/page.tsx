...
export default function SchoolProjectDetailPage() {
  ...
  const handleRevisionSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      // Transition state to submitted again
      setProject((prev: any) => ({
        ...prev,
        status: "submitted",
      }));
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white border border-slate-200/80 p-5 rounded-2xl shadow-sm">
        <div className="space-y-2">
          ...
          <h2 className="text-lg font-bold text-slate-800 font-playfair leading-snug">{project.title}</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Col: Circumstances details (2/3) */}
