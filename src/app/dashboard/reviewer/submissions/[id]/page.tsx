...
export default function ReviewerSubmissionDetailPage() {
  ...
  const idStr = Array.isArray(params?.id) ? params.id[0] : params?.id || "1";
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white border border-slate-200/80 rounded-2xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="space-y-2">
          ...
          <h2 className="text-lg font-bold text-slate-800 font-playfair leading-snug">{submission.title}</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Col: Details & Attachments & Timeline (2/3) */}
              ...
              {submission.files.proposal && (
                <div className="flex items-center justify-between p-3 bg-slate-50 rounded-xl border border-slate-100">
                  ...
                  <button
                    ...
                    className="p-1.5 text-[#006B3F] hover:bg-white rounded-lg border border-transparent hover:border-slate-200 flex-shrink-0"
                    title="Xem"
                  >
                      ...
                      <div className="space-y-3 text-xs bg-emerald-50/50 p-4 rounded-xl border border-emerald-100">
                        ...
                        <div className="flex items-center gap-2 pt-2">
                          <button
                            ...
                            className="px-3 py-1.5 bg-[#006B3F] text-white font-bold rounded-lg text-[10px]"
                          >
                            Đồng ý duyệt
                          </button>
                          <button
                            ...
                            className="px-3 py-1.5 border border-slate-200 text-slate-600 rounded-lg text-[10px] font-bold"
                          >
                            Hủy
                          </button>
                        </div>
                      ...
                      <form onSubmit={handleRevisionRequest} className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            type="submit"
                            disabled={isProcessing}
                            className="flex-1 py-2 bg-amber-600 text-white font-bold rounded-lg text-xs"
                          >
                            Gửi yêu cầu
                          </button>
                          <button
                      ...
                      <form onSubmit={handleRejectRequest} className="space-y-3">
                        ...
                        <div className="flex gap-2">
                          <button
                            type="submit"
                            disabled={isProcessing}
                            className="flex-1 py-2 bg-rose-600 text-white font-bold rounded-lg text-xs"
                          >
                            Xác nhận từ chối
                          </button>
                          <button
