...
export default function CreateProjectPage() {
  ...
  const [formData, setFormData] = useState({
    ...
    circumstance: "",
    amountNeeded: "",
    bankAccount: "1166889999", // Mock default MB bank
  ...
  const handleFileUpload = (fieldName: string, e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      // Simulate file upload setting file name
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Simulate API request saving the project
    setTimeout(() => {
      setIsSubmitting(false);
      alert("Nộp đề xuất thành công! Đề xuất đã được gửi tới Quỹ để xét duyệt.");
      router.push("/dashboard/school/projects");
    }, 1500);
  };
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {/* Page Title */}
      <div>
        <h2 className="text-xl font-bold text-slate-800 font-playfair">Đăng ký đề xuất hỗ trợ mới</h2>
        ...
        {currentStep === 4 && (
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Document 1: Written proposal from school */}
              ...
              {/* Document 2: Academic Achievements / Transcripts */}
              <div className="p-4 bg-slate-50/50 border border-slate-200 rounded-xl space-y-3 flex flex-col justify-between">
                <div className="space-y-1">
                  <span className="flex items-center gap-1.5 text-xs font-bold text-slate-800">
